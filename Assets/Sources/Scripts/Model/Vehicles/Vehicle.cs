...
namespace CrazyRacing.Model
{
    public abstract class Vehicle
    {
        ...
        {
            Vector3 vector = new Vector3(0, 0, direction) * Time.deltaTime * Config.VehicleRotationForce;
            RotatingVertical?.Invoke(vector);
        }

        public void RotateHorizontal(float direction)
        {
            Vector3 vector = new Vector3(direction, 0, 0) * Time.deltaTime * Config.VehicleRotationForce;
